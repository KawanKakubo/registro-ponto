    ...
    <div class="flex items-center mb-6">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900">
                <i class="fas fa-sitemap text-blue-600 mr-3"></i>Novo Departamento
            </h1>
            <p class="text-gray-600 mt-2">Cadastre um novo departamento no sistema</p>
        </div>
    </div>
        ...
        <form action="{{ route('departments.store') }}" method="POST">
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        <p class="text-sm text-blue-800">
                            <strong>Dica:</strong> Organize seus colaboradores em departamentos para facilitar a gestão e geração de relatórios.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit" class="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition shadow-lg hover:shadow-xl">
                    <i class="fas fa-save mr-2"></i>Salvar Departamento
                </button>
            </div>
        </form>
    </div>
