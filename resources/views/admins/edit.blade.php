    ...
    <div class="mb-6">
        <div class="flex items-center space-x-4 mb-4">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Atualize as informações do administrador</p>
            </div>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('admins.update', $admin) }}">
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    value="{{ old('cpf', substr($admin->cpf, 0, 3) . '.' . substr($admin->cpf, 3, 3) . '.' . substr($admin->cpf, 6, 3) . '-' . substr($admin->cpf, 9, 2)) }}"
                    maxlength="14"
            ...
            <div class="mb-6">
                ...
                >
                    ...
                    @foreach($establishments as $establishment)
                        <option value="{{ $establishment->id }}" {{ old('establishment_id', $admin->establishment_id) == $establishment->id ? 'selected' : '' }}>
            ...
            <div class="mb-6">
                ...
                @error('password')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
                <p class="mt-2 text-sm text-gray-500">Deixe em branco para manter a senha atual. Mínimo de 6 caracteres para alterar.</p>
            </div>
            ...
            <div class="flex items-center justify-end space-x-4">
                ...
                >
                    <i class="fas fa-save mr-2"></i>Atualizar Administrador
                </button>
            </div>
        </form>
    </div>
